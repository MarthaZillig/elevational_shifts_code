...
data <- list(C = C, M =nrow(C), J = ncol(C), n_point = n_point, n_canyon = n_canyon, point = bhgr$point, canyon = bhgr$canyon, year = year, elev = elev, interact = interact, spring_ppt = spring_ppt, spring_temp = spring_temp, winter_ppt = winter_ppt, max_ndvi = max_ndvi, time = time, yday = yday, obs_num=obs_num, n_obs=n_obs, a.vec = a.vec)
